-- works on krnl, synapse x, and maybe others.

-- probably works on WRD API but I wouldn't recommend it

-- library by wally, script by GcDevz
...
local messages = {
    ...
    "gcdevz on top!",
    "jack is dumb",
    "someone isn't using GcDevz's script",
    "get pwned omegalul"
}
...
local window = library:CreateWindow('SA&FYT') do
    ...
    window:AddLabel({text = 'Made by GcDevz'})
end
